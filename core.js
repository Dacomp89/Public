({
	...
	init: function () {
		...
		console.log('true');
			...
			o.core.el.donationLink.appendChild(document.createTextNode('Donate1'));
							...
							var amaFunc = function(r) {
								if (r.status == '200') {
									if (r.responseText.indexOf('[\u0022ama\u0022') !== -1) {
										/* find the ending point of the array so all we're left with is '["ama",60,5,[ ... ]] - the 4th item (index 3) in this array is an array of accounts' */
